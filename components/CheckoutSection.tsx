      ...
      <form className="checkout-form" onSubmit={submitOrder}>
        ...
        {checkout.fulfillment === "delivery" && (
          <div className="address-block">
            ...
            >
              <MapPin size={18} />
              {checkout.address ? "Editar endereço" : "Adicionar endereço"}
            </button>

            {checkout.address && (
              <p className="address-preview">{checkout.address}</p>
            )}
              ...
              <div className="address-panel">
                ...
                <button
                  ...
                  onClick={() => {
                    updateField(
                      "address",
                      `${checkout.deliveryAddress.street}, ${checkout.deliveryAddress.number} - ${checkout.deliveryAddress.neighborhood} ${checkout.deliveryAddress.complement}`
                    );
        ...
        <button
          ...
          type="submit"
          disabled={cartIsEmpty || status === "loading" || !storeConfig.lojaAberta}
        >
